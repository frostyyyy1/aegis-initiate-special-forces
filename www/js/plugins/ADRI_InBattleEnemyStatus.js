...
//=============================================================================
 /*:
 * @plugindesc (v1.3) Enemy status display window. 
 *
 *
 ...
 * @default ???
 *
 * @param Hide Actor Status Window
 * @parent ---General---
 * @type boolean
 * @on YES
 * @off NO
 * @desc Hide the actor status window when the enemy
 * status window is active? NO - false   YES - true
 * @default false
 *
...
ADRI.Params.HideActorStatusWindow = eval(ADRI.Parameters['Hide Actor Status Window']);
...
Scene_Battle.prototype.onInBattleEnemyStatusCancel = function() {
  ...
  if (ADRI.Params.HideActorStatusWindow) {
...
if (Imported.YEP_X_TurnOrderDisplay) {
	ADRI_InBattleEnemyStatus_Window_TurnOrderIcon_isReduceOpacity =
		Window_TurnOrderIcon.prototype.isReduceOpacity;
	Window_TurnOrderIcon.prototype.isReduceOpacity = function() {
		if (SceneManager._scene._inBattleEnemyStatusWindow) {
			if (SceneManager._scene._inBattleEnemyStatusWindow.visible) return true;
		}
		return ADRI_InBattleEnemyStatus_Window_TurnOrderIcon_isReduceOpacity.call(this);
	};
}
