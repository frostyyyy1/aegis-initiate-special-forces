...
LGP.Param.Fire = 'rgb(227,212,0)';
LGP.Param.FireO = 'rgb(0,0,0)';
LGP.Param.Ice = 'rgb(100,255,100)';
LGP.Param.IceO = 'rgb(20,20,20)';
LGP.Param.Electric = 'rgb(50,0,150)';
LGP.Param.ElectricO = 'rgb(0,0,0)';
LGP.Param.Water = 'rgb(2,5,184)';
LGP.Param.WaterO = 'rgb(0,103,163)';
LGP.Param.Grass = 'rgb(3,82,22)';
LGP.Param.GrassO = 'rgb(14,48,22)';
LGP.Param.Steel = 'rgb(80,80,80)';
LGP.Param.SteelO = 'rgb(160,160,160)';
LGP.Param.Light = 'rgb(255,251,184)';
LGP.Param.LightO = 'rgb(255,255,255)';
LGP.Param.Dark = 'rgb(50,0,150)';
LGP.Param.DarkO = 'rgb(20,20,20)';
...
Sprite_Damage.prototype.drawDefaultNumber = function() {
    ...
    if (result.hpAffected) {
        if (value > 0) {
			...
			bitmap.outlineColor = LGP.Param.FireO;
                } else {
                if (result.itemElements == 3) {
			bitmap.textColor = LGP.Param.Ice;
			bitmap.outlineColor = LGP.Param.IceO;
                } else {
                if (result.itemElements == 4) {
			bitmap.textColor = LGP.Param.Electric;
			bitmap.outlineColor = LGP.Param.ElectricO;
                } else {
                if (result.itemElements == 5) {
			bitmap.textColor = LGP.Param.Water;
			bitmap.outlineColor = LGP.Param.WaterO;
                } else {
                if (result.itemElements == 6) {
			bitmap.textColor = LGP.Param.Grass;
			bitmap.outlineColor = LGP.Param.GrassO;
                } else {
                if (result.itemElements == 7) {
			bitmap.textColor = LGP.Param.Steel;
			bitmap.outlineColor = LGP.Param.SteelO;
                } else {
                if (result.itemElements == 8) {
			bitmap.textColor = LGP.Param.Light;
			bitmap.outlineColor = LGP.Param.LightO;
                } else {
                if (result.itemElements == 9) {
			bitmap.textColor = LGP.Param.Dark;
			bitmap.outlineColor = LGP.Param.DarkO;
                } else {
                    bitmap.textColor = LGP.Param.BDPhpDmgC;   
                    bitmap.outlineColor = LGP.Param.BDPhpDmgOC;        
                }}}}}}}}} // An additional bracket for each element.
            }
        } else {
...
Sprite_Damage.prototype.drawDefaultState = function() {
    ...
    for (var i = 0; i < addedStates.length; i++) {
        ...
        stateSprite.anchor.x = 0.2;
        stateSprite.anchor.y = 0.2 + i; 
        ...
        bitmap.drawText(Window_Base._iconWidth + 5, 0, 0, h);
    }
    for (var i = 0; i < removedStates.length; i++) {
        ...
        stateSprite.anchor.x = -0.2;
        stateSprite.anchor.y = (-0.2 + addedStates.length) + i; 
